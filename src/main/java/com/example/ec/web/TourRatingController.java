...
public class TourRatingController {
     ...
     */
    @GetMapping
    public PagedResources<RatingDto> getAllRatingsForTour(@PathVariable(value = "tourId") int tourId, Pageable pageable, PagedResourcesAssembler pagedResourcesAssembler) {
        LOGGER.info("GET /tours/{}/ratings", tourId);
        Page<TourRating> tourRatingPage = tourRatingService.lookupRatings(tourId, pageable);
        return pagedResourcesAssembler.toResource(tourRatingPage, ratingAssembler);
    }
    ...
    private RatingDto toDto(TourRating tourRating) {
        return ratingAssembler.toResource(tourRating);
    }
