...
public class RatingAssemblerTest {
    ...
    private static final int CUSTOMERS_ID = 1000;
    ...
    @InjectMocks
    private RatingAssembler assemblerMock;
    ...
    public void toResource() {
        ...
        when(tourRatingMock.getCustomerId()).thenReturn(CUSTOMERS_ID);
        ...
        RatingDto dto = assemblerMock.toResource(tourRatingMock);
