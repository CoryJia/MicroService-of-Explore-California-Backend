...
public class TourRatingControllerTest {
    ...
    /**
     * HTTP POST /tours/{tourId}/ratings/{score}?customers={id..}
     */
    @Test
    ...
    public void getAllRatingsForTour() throws Exception {
        List<TourRating> tourRatingList = Arrays.asList(tourRatingMock);
        Page<TourRating> page = new PageImpl<>(tourRatingList, PageRequest.of(0, 10), 1);
