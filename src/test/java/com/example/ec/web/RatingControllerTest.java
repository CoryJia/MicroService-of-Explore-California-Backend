...
public class RatingControllerTest {
    ...
    @Before
    public void setupReturnValuesOfMockMethods() throws Exception {
    ...
    public void getRatings() {
        ...
        ResponseEntity<List<RatingDto>> response = restTemplate.exchange(RATING_URL, HttpMethod.GET, null, new ParameterizedTypeReference<List<RatingDto>>() {
        });
    ...
    public void getOne() {
        ...
        ResponseEntity<RatingDto> response = restTemplate.getForEntity(RATING_URL + "/" + RATING_ID, RatingDto.class);
